...
md"## Solve the Poisson equation in 3D"
...
# ╔═╡ 3332a8b3-c16e-410e-b4c4-28adec71f352
...
# ╔═╡ 9be83ec4-dc82-4a6c-819c-0b29d96a111c
g(x) = 2.0;

# ╔═╡ 7d73b522-3ce3-4691-8c8a-ab71596894a2
h(x) = 3.0;

# ╔═╡ 35dcbc0a-ad7a-4598-9e93-ba6601196e16
md"Find $u\in U_h \text{ such that }  a(u,v) = b(v)  \text{ for all } v\in V_h$" 
...
# ╔═╡ 48271616-da26-40e7-b694-b51bc94f971f
U = TrialFESpace(V,g);

# ╔═╡ 432ec7df-bbc7-4c6c-aaa0-128723399b51
neumanntags = ["circle", "triangle", "square"];

# ╔═╡ 8735cdb0-a555-4a12-b129-6a404d0ef742
...
# ╔═╡ b164daa0-ff8e-4a05-8dd7-c37db7da9d8f
dΓ = Measure(Γ,degree);
...
md"There are other solvers available:
